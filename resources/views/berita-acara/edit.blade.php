                    ...
                    <form action="{{ route('berita-acara.update', $beritaAcara->id) }}" method="POST" enctype="multipart/form-data" id="baForm">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="biaya_registrasi" class="form-control @error('biaya_registrasi') is-invalid @enderror" value="{{ old('biaya_registrasi', $beritaAcara->biaya_registrasi) }}" placeholder="0" required>
